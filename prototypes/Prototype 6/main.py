# PROTOTYPE 6
# THIS PROTOTYPE IMPLEMENTS LOGIC.
# SOCKETS WILL OUTPUT AND RECEIVE BINARY VALUES.
# WIRES WILL TRANSMIT BINARY VALUES.
# LOGIC GATES WILL PERFORM LOGIC ON SAID BINARY VALUE INPUTS AND GIVE AN OUTPUT.
